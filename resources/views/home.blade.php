...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/frame7.css') }}">
    ...
    <header>
        ...
        <div class="categories">
            @foreach ($categories as $category)
                <p class="active">{{ $category->name }}</p>
            {{-- <p class="active">Branding Records</p>
            <p class="deActive">Marketing Records</p> --}}
        </div>
    </header>
    <div class="recordsContainer">
        @foreach ($cateory->videos as $video)
        <div class="record">
            <div class="img">
